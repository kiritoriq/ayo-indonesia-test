                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header card-header-tabs-line">
                        <div class="card-toolbar">
                            <ul class="nav nav-tabs nav-bold nav-tabs-line">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#data-rs">
                                        <span class="nav-icon"><i class="fas fa-hospital-alt"></i></span>
                                        <span class="nav-text font-13 font-weight-bold">Rumah Sakit Jawa Tengah</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="data-rs" role="tabpanel" aria-labelledby="data-rs">
