...
<div class="container py-5 max-w-700px">
    <div class="card card-custom">
        <div class="card-header">
            <h3 class="card-title">
                Buat Baru Kategori Aduan
            </h3>
        </div>
        <form action="{{ route('jenis-aduan.create.action') }}" method="POST" class="form" id="formSubmit">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-8 col-8">
                        <input type="text" name="jenis_aduan" class="form-control" placeholder="Masukkan nama kategori aduan" id="jenis_aduan" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-4 col-4 col-form-label">
                    ...
                    <div class="col-lg-8 col-8">
                        <label class="checkbox">
                            <input type="checkbox" class="check" name="isAktif" value="1" checked>
                            <span></span> Aktif
                        </label>
                    </div>
                </div>
